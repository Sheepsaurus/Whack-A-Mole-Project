...
namespace Assets.Scripts {
    public class MouseMovement : MonoBehaviour {
        ...
        private void Update() {
            ...
            MouseBehaviour(12 - OptionStuff
                               .OptionDifficulty); // THE DIFFICULTY SLIDER HAS VALUES 10 -> 2, THIS INVERTS IT
        }
            ...
            public void MouseBehaviour(float speedAdjustUp) {
                ...
                if (!_hasBeenClicked) {
                    ...
                    if (Input.touchCount > 0 && Input.GetTouch(0).phase == TouchPhase.Ended) {
                        Vector3 wp =
                            Camera.main.ScreenToWorldPoint(Input.GetTouch(0)
                                .position); // CREATE A Vector3 BASED ON THE POSITION
                        // OF THE TOUCH
                    ...
                    // OTHERWISE, IF THE INTERNAL TIMER REACHES HALF OF THE LIFESPAN OF THE MOUSE
                        ...
                        if (_timer < 0) {
                            transform.Translate(0, -(SpeedAdjustDown * Time.deltaTime),
                                0); // MOVE GAMEOBJECT DOWNWARDS ON THE Y AXIS
                        }
                    ...
                    // OTHERWISE, IF THE CURRENT POSITION ON THE Y AXIS IS LOWER THAN THE _maxY VALUE
                        ...
                        transform.Translate(0, speedAdjustUp * Time.deltaTime, 0); // MOVE GAMEOBJECT UPWARDS ON THE Y AXIS
                    }
                }
            }
            #endregion
